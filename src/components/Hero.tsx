...
export const Hero = () => {
  ...
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-900/30 border border-green-500/30 text-green-400 text-sm mb-8">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight text-transparent bg-clip-text bg-linear-to-r from-green-400 to-emerald-600 text-shadow-glow">
          Deploit
        </h1>
        ...
        <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          <br />
          <span className="text-sm md:text-base mt-2 block text-gray-500">Docker • Nginx • Let's Encrypt • One Command</span>
        </p>

        <div className="max-w-2xl mx-auto bg-black/80 border border-gray-700 rounded-lg p-4 shadow-2xl backdrop-blur-sm group hover:border-green-500/50 transition-colors">
          <div className="flex items-center justify-between gap-4 font-mono text-sm md:text-base">
            <div className="flex items-center gap-3 text-gray-300 overflow-x-auto scrollbar-hide">
